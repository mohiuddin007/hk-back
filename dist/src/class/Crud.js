...
var Crud = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, response.badRequestResponse(error_1 === null || error_1 === void 0 ? void 0 : error_1.message)];
                    case 5: return [2 /*return*/];
                }
            });
        });
    };
    Crud.prototype._saveDataMany = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var savedData, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        if (!data) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.modelName.insertMany(data)];
                    case 1:
                        savedData = _a.sent();
                        return [2 /*return*/, response.successResponse(savedData)];
                    case 2: return [2 /*return*/, response.badRequestResponse("Fill Requeued felid")];
                    ...
                    case 4:
                        error_2 = _a.sent();
                        console.log({ crudSave: error_2 });
                        return [2 /*return*/, response.badRequestResponse(error_2 === null || error_2 === void 0 ? void 0 : error_2.message)];
                    case 5: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_5 = _a.sent();
                        console.log({ crudGetAll: error_5 });
                        return [2 /*return*/, response.serverErrorResponse()];
                    case 3: return [2 /*return*/];
                }
            });
    ...
    Crud.prototype._updateData = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            var findData, updateData, updatedData, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                    ...
                    case 7:
                        error_6 = _a.sent();
                        console.log({ crudUpdate: error_6 });
